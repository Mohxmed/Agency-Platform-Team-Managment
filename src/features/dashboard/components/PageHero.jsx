      ...
      <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex items-center gap-4">
          <div className="relative flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-white/15 text-white shadow-lg ring-4 ring-white/20 transition-all duration-500 group-hover:scale-105">
            ...
            <span
              className={`absolute -bottom-1 -left-1 h-3 w-3 rounded-full bg-white ring-2 ${hero.dotRing}`}
            />
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              {badge && (
                <span
                  className={`rounded-md bg-white px-2 py-1 text-[10px] font-black tracking-wide ${hero.badgeText}`}
                >
                  {badge}
                </span>
              )}

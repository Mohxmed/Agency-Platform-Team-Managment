...
export default function TeamHero({
  ...
  return (
    <section
      className={`group relative overflow-hidden rounded-[28px] border ${theme.heroBg} ${theme.heroBgDark} p-6 shadow-sm transition-shadow duration-300 hover:shadow-md sm:p-8`}
    >
      <div
      ...
      <div className="pointer-events-none absolute -bottom-24 right-1/3 h-48 w-48 rounded-full bg-ink/[0.035] blur-3xl" />
